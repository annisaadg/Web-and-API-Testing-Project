Feature: DELETE
  ...
  @delete-positive
  Scenario: Test to delete existing user data with valid app-id in header
    Given I set up the URL for "delete user"
    And I prepare the app-id "662ca6cad9ec7557d41a378a"
    When I send a DELETE request with the user id "665d21404fd1794d7f76ae6a"
  ...
  @delete-negative
  Scenario: Test to delete existing user data with invalid app-id in header
    Given I set up the URL for "delete user"
  ...
  @delete-negative
  Scenario: Test to delete non-existing user data with valid app-id in header
    Given I set up the URL for "delete user"
    And I prepare the app-id "662ca6cad9ec7557d41a378a"
  ...
  @delete-negative
  Scenario: Test to delete data by passing invalid user id format as parameter with valid app-id in header
    Given I set up the URL for "delete user"
    And I prepare the app-id "662ca6cad9ec7557d41a378a"
